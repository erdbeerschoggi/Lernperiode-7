...
- [x] Nachschauen ob die funktionen, die mit der alten API funktionierten, trotzdem implementiert werden können.
- [x] Den Countdown verbessern, so dass dieser wirklich 24h läuft und nicht erst anfängt wenn man die Webseite besucht.
